<?php
 ...
 <!-- Breadcrumbs-->
       ...
       <h3 > <button type="button" class="btn btn-success"><a style='color:white ' href="CreateStudent.php">Add </a></button></h3>
   <table class="table">
   <hr>
        ...
        <?php
          foreach($rsFromFile as $key => $value){
             ...
             echo " <td>";
             echo "  <button type='button' class='btn btn-primary'><a style='color:white 'href='EditStudent.php?m=$value->id'>Chỉnh sửa</a></button>";
             echo "  <button type='button' class='btn btn-danger'><a style='color:white 'href='DeleteStudent.php?m=$value->id'>Xóa</a></button>";
             echo " </td>";
             echo " </tr>";
